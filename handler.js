...
let msg = {
    rowner: `Maaf kak, fitur ini khusus developerku!`,
    owner: `Ngapain kak?, fitur ini khusus ownerku!`,
    mods: `Maaf kak, fitur ini khusus moderator bot!`,
    premium: `Fitur ini khusus premium user`,
    group: `Fitur ini hanya bisa di gunakan di grub`,
    private: `Fitur Ini Khusus Private Chats!`,
    admin: `Fitur ini khusus admin grub!`,
    botAdmin: `Jadikan bot sebagai admin untuk menggunakan fitur ini`,
    nsfw: `Nsfw tidak aktif!`,
    rpg: `Rpg tidak aktif!`,
    restrict: `Maaf fitur ini di disable!`}[type]
if (msg) return conn.sendMessage(m.chat, {
text: msg,
contextInfo: {
externalAdReply: {
title: '——— 「 Simple whatsapp bot ツ 」 ———',
thumbnailUrl: "https://telegra.ph/file/c97dcdd6b5d9110916f5c.jpg",
sourceUrl: sgc,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
let msgg = {
    unreg: `Hai Kak, Silahkan daftar ke database terlebih dahulu untuk menggunakan bot ini\nPenggunaan : .register yourname.age\nContoh : .register manusia.20`}[type]
if (msgg) return conn.sendMessage(m.sender, {
text: msgg,
contextInfo: {
externalAdReply: {
title: '——— 「 Not registered 」 ———',
thumbnailUrl: "https://telegra.ph/file/18bc8ed8de5723059f51c.jpg",
sourceUrl: sgc,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
